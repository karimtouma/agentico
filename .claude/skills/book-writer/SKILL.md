...
Genera un caso de estudio de aproximadamente 20 páginas a partir de una
empresa real, investigada con WebSearch.

**Regla dura:** nunca inventes empresas, sitios web, cifras ni citas. Si la
investigación no arroja datos publicos suficientes, di que no hay caso y
propone otro tema. El libro elimino deliberadamente todo contenido ficticio;
un caso inventado es una regresion, no un borrador.
