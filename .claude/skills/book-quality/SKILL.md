...
Directorio base del libro: `ingenieria_agentica/`
Capítulos: `ingenieria_agentica/capitulos/`
Apéndices: `ingenieria_agentica/apendices/`
...
1. **Definir alcance.** Si se indicó un capítulo, buscar el archivo con Glob en `ingenieria_agentica/capitulos/*{NUMERO}*.md`. Si es `all`, procesar todos los `.md` en `capitulos/` y `apendices/`.
