...
Comandos para enriquecer, estandarizar y medir la calidad del contenido editorial. Cada comando modifica o reporta sobre archivos en `ingenieria_agentica/`.
...
1. **Leer las primeras 50 líneas** del capítulo en `ingenieria_agentica/capitulos/` para entender su contexto.
...
4. **Cross-check contra Apéndice D.** Leer `ingenieria_agentica/apendices/D_recursos.md` y verificar que las fuentes principales citadas aparezcan en la sección de recursos.
